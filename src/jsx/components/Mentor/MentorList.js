          ...
          <div className="col-xl-12">
            ...
            <Tab.Content>
              ...
              <Tab.Pane eventKey="Approved">
                <Approved mentorList={jobData} mentorss={mentors} />
              </Tab.Pane>
              <Tab.Pane eventKey="Pending">
                <Pending mentorList={jobData} mentorss={mentors} />
              </Tab.Pane>
              <Tab.Pane eventKey="Reject">
                <Reject mentorList={jobData} mentorss={mentors} />
              </Tab.Pane>
            </Tab.Content>
          </div>
        </div>
