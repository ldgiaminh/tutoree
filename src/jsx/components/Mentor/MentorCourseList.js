...
const MentorCourseList = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await CourseService.getMentorCourseId(id);
                                    ...
                                    <div>
                                      <h4 className="mb-0 mt-1">
                                        <Link
                                          ...
                                          to={`./${course.id}-course-tutor-detail`}
                                        >
                                          {course.name}
                                        </Link>
                                      </h4>
...
export default connect(mapStateToProps)(MentorCourseList);
